namespace TestManagement.Domain.Model
{
    ...
    /// テスト項目名
    /// </summary>
    public class TestItemName : IEquatable<TestItemName>
    {
        #region Fields
        ...
        /// デフォルト
        /// </summary>
        public static readonly TestItemName Default = new(string.Empty);
        ...
        public static bool operator ==(TestItemName lhs, TestItemName rhs)
        {
        ...
        public static bool Validate(string s, out string message)
        {
            ...
            {
                message = "テスト項目名は、20桁以下で入力してください。";
            }
        ...
        public override bool Equals(object? obj)
        {
            ...
            {
                TestItemName other => Equals(other),
                _ => base.Equals(obj),
            };
        ...
        public bool Equals(TestItemName? other)
        {
