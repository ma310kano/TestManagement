namespace TestManagement.Domain.Model
{
    ...
    /// 実行手順
    /// </summary>
    public class ExecutionProcedure : IEquatable<ExecutionProcedure>
    {
        #region Fields
        ...
        /// デフォルト
        /// </summary>
        public static readonly ExecutionProcedure Default = new(string.Empty);
        ...
        public ExecutionProcedure(string value)
        {
        ...
        public static bool operator ==(ExecutionProcedure lhs, ExecutionProcedure rhs)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            {
                ExecutionProcedure other => Equals(other),
                _ => base.Equals(obj),
            };
        ...
        public bool Equals(ExecutionProcedure? other)
        {
