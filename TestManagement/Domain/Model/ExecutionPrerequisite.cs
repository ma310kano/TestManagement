namespace TestManagement.Domain.Model
{
    ...
    /// 実行前提条件
    /// </summary>
    public class ExecutionPrerequisite : IEquatable<ExecutionPrerequisite>
    {
        #region Fields
        ...
        /// デフォルト
        /// </summary>
        public static readonly ExecutionPrerequisite Default = new(string.Empty);
        ...
        public ExecutionPrerequisite(string value)
        {
        ...
        public static bool operator ==(ExecutionPrerequisite lhs, ExecutionPrerequisite rhs)
        {
        ...
        public static bool Validate(string s, out string message)
        {
            ...
            {
                message = "実行前提条件は、99桁以下で入力してください。";
            }
        ...
        public override bool Equals(object? obj)
        {
            ...
            {
                ExecutionPrerequisite other => Equals(other),
                _ => base.Equals(obj),
            };
        ...
        public bool Equals(ExecutionPrerequisite? other)
        {
