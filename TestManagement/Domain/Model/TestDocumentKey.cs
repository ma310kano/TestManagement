...
namespace TestManagement
{
    ...
    public class TestDocumentKey
    {
        ...
        /// デフォルト
        /// </summary>
        public static readonly TestDocumentKey Default = new(string.Empty);
		...
		public TestDocumentKey(string value)
        {
        ...
        public static bool operator ==(TestDocumentKey lhs, TestDocumentKey rhs)
        {
        ...
        public static bool Validate(string s, out string message)
        {
            ...
            {
                message = "テストキーは、半角英数字20桁(ハイフン含む)で入力してください。";
            }
        ...
        public override bool Equals(object? obj)
        {
            ...
            {
                TestDocumentKey other => Equals(other),
                _ => base.Equals(obj),
            };
        ...
        public bool Equals(TestDocumentKey? other)
        {
