namespace TestManagement.Domain.Model
{
    ...
    /// 期待結果
    /// </summary>
    public class ExpectedResult : IEquatable<ExpectedResult>
    {
        #region Fields
        ...
        /// デフォルト
        /// </summary>
        public static readonly ExpectedResult Default = new(string.Empty);
        ...
        public ExpectedResult(string value)
        {
        ...
        public static bool operator ==(ExpectedResult lhs, ExpectedResult rhs)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            {
                ExpectedResult other => Equals(other),
                _ => base.Equals(obj),
            };
