namespace TestManagement.Domain.Model
{
    ...
    /// テスト対象名
    /// </summary>
    public class TestTargetName : IEquatable<TestTargetName>
    {
        #region Fields
        ...
        /// デフォルト
        /// </summary>
        public static readonly TestTargetName Default = new(string.Empty);
        ...
        public TestTargetName(string value)
        {
        ...
        public static bool operator ==(TestTargetName lhs, TestTargetName rhs)
        {
        ...
        public static bool Validate(string s, out string message)
        {
            ...
            {
                message = "テスト対象名は、20桁以下で入力してください。";
            }
        ...
        public override bool Equals(object? obj)
        {
            ...
            {
                TestTargetName other => Equals(other),
                _ => base.Equals(obj),
            };
        ...
        public bool Equals(TestTargetName? other)
        {
